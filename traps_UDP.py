...
def interfaz_traps_UDP(ip_pablo, comunidad_pablo, correo_pablo):   
    ...
    ventana = Toplevel()
    ventana.title("Interfaz de monitorización del grupo UDP")
    ...
    opciones = ["udpInDatagrams", "udpNoPorts", "udpInErrors", "udpOutDatagrams"]
    lista_oids = ["1.3.6.1.2.1.7.1.0", "1.3.6.1.2.1.7.2.0", "1.3.6.1.2.1.7.3.0", "1.3.6.1.2.1.7.4.0"]
...
#interfaz_traps_UDP("127.0.0.1", "TrabajoGestion", "gestiontrabajo10@gmail.com")