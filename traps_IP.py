...
def interfaz_traps_IP(ip_pablo, comunidad_pablo, correo_pablo):   
    ...
    def main():
        try:
            ...
            if valido:
                ...
                archivo_comunica = open("comunica.txt",
                                        "w")  # Archivo para pasarle los parametros al programa que monitorizará
    ...
    def valida_campos():
        ...
        if (lista_desplegable.get() == ""):
            ...
            if ((var1.get() == 1) and (var2.get() == 1)):  # Definir ambos umbrales
                if ((entrada1.get() == "") or (entrada2.get() == "") or (entrada3.get() == "") or (
                        entrada4.get() == "")):
                    valido_umbrales = False
                else:
        ...
        if ((valido_umbrales == False) and (valido_valor == False) and (valido_lista == False)):
            messagebox.showerror("Error",
                                 "No ha elegido ningún objeto de gestión a monitorizar, error en umbrales, error en sample type")
    ...
    ventana = Toplevel()
    ventana.title("Interfaz de monitorización del grupo IP")
    ...
    opciones = ["ipForwarding", "ipInReceives", "ipInHdrErrors", "ipInAddrErrors", "ipForwDatagrams", "ipInDiscards",
                "ipInDelivers", "ipOutRequests", "ipOutDiscards", "ipOutNoRoutes", "ipReasmOKs", "ipReasmFails",
                "ipFragOKs", "ipFragFails", "ipRoutingDiscards"]
    lista_oids = ["1.3.6.1.2.1.4.1.0", "1.3.6.1.2.1.4.3.0", "1.3.6.1.2.1.4.4.0", "1.3.6.1.2.1.4.5.0",
                  "1.3.6.1.2.1.4.6.0", "1.3.6.1.2.1.4.8.0", "1.3.6.1.2.1.4.9.0", "1.3.6.1.2.1.4.10.0",
                  "1.3.6.1.2.1.4.11.0", "1.3.6.1.2.1.4.12.0", "1.3.6.1.2.1.4.15.0", "1.3.6.1.2.1.4.16.0",
                  "1.3.6.1.2.1.4.17.0", "1.3.6.1.2.1.4.18.0", "1.3.6.1.2.1.4.23.0"]
    ...
    ventana.mainloop()
#interfaz_traps_IP("127.0.0.1", "TrabajoGestion", "gestiontrabajo10@gmail.com")