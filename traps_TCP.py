...
def interfaz_traps_TCP(ip_pablo, comunidad_pablo, correo_pablo):   
    ...
    ventana = Toplevel()
    ventana.title("Interfaz de monitorización del grupo TCP")
    ...
    opciones = ["tcpActiveOpens", "tcpPassiveOpens", "tcpAttemptFails", "tcpEstabResets", "tcpCurrEstab", "tcpInSegs", "tcpOutSegs", "tcpRetransSegs", "tcpInErrs", "tcpOutRsts"]
    lista_oids = ["1.3.6.1.2.1.6.5.0", "1.3.6.1.2.1.6.6.0", "1.3.6.1.2.1.6.7.0", "1.3.6.1.2.1.6.8.0", "1.3.6.1.2.1.6.9.0", "1.3.6.1.2.1.6.10.0", "1.3.6.1.2.1.6.11.0", "1.3.6.1.2.1.6.12.0", "1.3.6.1.2.1.6.14.0", "1.3.6.1.2.1.6.15.0"]
...
#interfaz_traps_TCP("127.0.0.1", "TrabajoGestion", "gestiontrabajo10@gmail.com")